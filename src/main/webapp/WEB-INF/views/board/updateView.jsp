				    ...
				    <div class="col-8">
					    <form role="form" name="updateForm" method="post" action="/board/update">
							...
							<div class="form-group">
							    ...
							    <textarea class="form-control" id="address" name="address" rows="3"><c:out value="${update.address}"/></textarea>
							</div>
							<div class="form-row">
							  	<div class="form-group col-md-4">
							      <label for="hire_date">입사일</label>
							      <input type="date" class="form-control" id="hire_date" name="hire_date" value="${update.hire_date }">
							    </div>
							    <div class="form-group col-md-4">
							      <label for="department_id">부서명</label>
							      <select id="inputDepartmentName" class="form-control" id="department_id" name="department_id" value="${update.department_id }">
							...
							<div class="form-row">
							    <div class="form-group col-md-4">
							      ...
							      <select id="inputBankName" class="form-control" id="bank_id" name="bank_id" value="${update.bank_id }">
							...
							<div class="form-group">
								<label for="email">Email</label>
							  	<input type="text" class="form-control" id="email" name="email" value="${update.email }">
							</div>		  
